...
# Regex para montos BCP: pueden tener comas de miles y punto decimal
# Ejemplos: 0.05  18.00  1,402.00  27,024.92
MONTO_RE = re.compile(r"\b(\d{1,3}(?:,\d{3})*\.\d{2})\b")

# Regex para fechas BCP: "01ABR", "30ABR", "31MAR"
FECHA_BCP_RE = re.compile(r"\b(\d{2})(ENE|FEB|MAR|ABR|MAY|JUN|JUL|AGO|SET|SEP|OCT|NOV|DIC)\b")
